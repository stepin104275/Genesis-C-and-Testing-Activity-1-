...
TEST(MyTime,plusoperator) {
    ...
    MyTime t3;
    t3=t1+t2;
    EXPECT_EQ(17,t3.hours());
    EXPECT_EQ(51,t3.minutes());
...
TEST(MyTime,plus) {
    ...
    MyTime t3;
    t3=t1+30;
    EXPECT_EQ(07,t3.hours());
    EXPECT_EQ(31,t3.minutes());
    EXPECT_EQ(0,t3.seconds());
}
